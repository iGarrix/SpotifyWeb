...
export const InviteCard: React.FC<IInviteCardProps> = ({...props}) => {
    ...
    return (
        <div className={`rounded-lg flex mm:flex-col sm:flex-col md:flex-col items-center justify-between gap-[20px] overflow-hidden bg-light-200 dark:bg-dark-100 shadow-md py-2 px-5 select-none text-dark-200 dark:text-light-200`}>
            ...
            <div className="flex gap-[20px] items-center mm:w-full mm:justify-between sm:w-full sm:justify-between md:w-full md:justify-between">
                <p className="whitespace-nowrap py-3">{moment(props.invite.create).format("DD/MM/YYYY - HH:mm")}</p>
