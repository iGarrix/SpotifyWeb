...
export const ArtistResultCard: React.FC<IArtistResultCard> = ({ ...props }) => {
    return (
        <div className="w-full h-full mm:h-auto sm:h-auto md:h-auto lg:h-auto rounded-xl bg-light-100 dark:bg-dark-200 flex flex-col gap-6 py-6 px-8 mm:px-3 mm:py-4 overflow-hidden cursor-pointer transition-all mainresultcard relative">
