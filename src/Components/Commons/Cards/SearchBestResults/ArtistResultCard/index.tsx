...
export const ArtistResultCard: React.FC<IArtistResultCard> = ({ ...props }) => {
    return (
        <div className="w-full h-full rounded-xl bg-light-200 dark:bg-dark-200 flex flex-col gap-6 py-6 px-8 overflow-hidden cursor-pointer transition-all mainresultcard relative">
