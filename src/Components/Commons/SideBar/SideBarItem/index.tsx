...
export const SideBarItem: React.FC<ISideBarItem> = ({ text, icon, isSelect, onClick }) => {
    return (
        <div className={`flex items-center gap-4 cursor-pointer text-[100%] ${isSelect ? "sidebaritem bg-light-300 dark:bg-dark-100/40" : "hover:bg-primary-100/60"}
        transition-all text-dark-200 dark:text-light-200 active:bg-light-100 dark:active:bg-dark-200`} onClick={onClick}>
