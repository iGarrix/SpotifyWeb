...
export const DefaultButton: React.FC<IDefaultButton> = ({ text, type, importantDark, onClick }) => {
    return (
        ...
        overflow-hidden rounded-xl shadow-xl select-none cursor-pointer ${importantDark ? "bg-dark-100/90 text-light-100" : "bg-blue-500 text-light-200"}`} onClick={onClick}>{text}</button>
    )
}