...
export const ProfileButton : React.FC<IProfileButton> = ({text, isSelect, onClick}) => {
    return (
        <button className={`py-2 px-[23px] my-3 bg-cover bg-no-repeat rounded-xl active:contrast-200 ${isSelect ? "contrast-150" : "contrast-75"} hover:contrast-150 transition-all`}
        onClick={onClick}
