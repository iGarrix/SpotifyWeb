      ...
      <div className="flex flex-col gap-1">
        <div className="flex gap-2 flex-wrap">
          <p className="text-dark-200 dark:text-light-200 font-medium">{title}</p>
            ...
            <div className="bg-light-200 dark:bg-dark-100 pr-2 rounded-xl">
        <select defaultValue={value}
          className="outline-0 w-full pr-20 text-dark-200 dark:text-light-200 flex flex-col bg-light-200 autofill:bg-light-100 dark:bg-dark-100 dark:autofill:dark:bg-dark-100 rounded-xl py-3 px-5"
          onChange={onChange}
        >
