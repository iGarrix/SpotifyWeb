...
export const RenameBioModal: React.FC<IRenameBioModal> = ({ onSave, onClose }) => {
    ...
    return (
        <div className="rounded-lg py-8 flex flex-col items-center gap-6 text-dark-200 bg-light-100 shadow-xl px-10">
            ...
            <h1 className="text-xl font-medium font-['Lexend']">Rename</h1>
            {
