...
export const ShareModal : React.FC<IShareAlbumModal> = ({...props}) => {
    ...
    return (
        <div className="rounded-lg flex flex-col gap-6 text-dark-200 bg-light-100 dark:text-light-200 dark:bg-dark-200 shadow-xl py-4 px-8 mx-[25%]">
            ...
            <div className="flex flex-col gap-1 w-full">
                ...
                <div className="flex w-full">
                    <div className="flex w-full justify-between bg-light-200 dark:bg-dark-100 shadow-sm rounded-md items-center gap-[64px] overflow-hidden">
                        <a href={props.link} className="text-md px-4 hover:text-primary-100 dark:hover:text-blue-400" target={"_blank"}>{props.link}</a>
