    ...
    return (
        <div className="overflow-hidden w-screen h-screen text-white flex justify-center items-center bg-black relative">
            ...
            <div className="flex flex-col items-center gap-4 z-[10]">
                ...
                <p className="font-thin text-lg">Upload your content: single & album</p>
                <div className="w-full flex flex-col gap-4">
                    <RedirectButton text="Upload new album" icon={icon_music} onClick={() => {navigate('album')}} />
                    <RedirectButton text="Upload new single" icon={icon_music} onClick={() => {navigate('single')}} />
                </div>
            </div>
        </div>
    )
