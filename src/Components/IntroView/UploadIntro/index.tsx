...
export const UploadIntro: React.FC = () => {
    ...
    return (
        <div className="overflow-hidden w-screen h-screen text-dark-200 flex justify-center items-center bg-light-100 relative">
            <Helmet>
                <title>Soundwave | Uploading</title>
            </Helmet>
            <div className="absolute top-0 w-screen h-1 rounded-br-lg rounded-bl-lg animate-pulse z-[10]"></div>
