                            ...
                            <Form>
                                <div className="w-full flex flex-col justify-center items-center gap-8">
                                    <div className="flex flex-col gap-3 w-full items-center">
                                        <h1 className="text-3xl font-['Lexend']">Forgot password?</h1>
                                        <p className="text-lg font-['Lexend']">Enter your email  address and we’ll send you a
                                    ...
                                    <div className="flex items-center justify-between w-full py-2 px-20">
