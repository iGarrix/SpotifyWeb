                ...
                <div className="z-10 flex flex-col gap-6">
                    ...
                    <div className="w-full flex flex-col justify-center items-center gap-8">
                        <div className="flex flex-col gap-3 w-full items-center">
                            <h1 className="text-3xl font-['Lexend']">Check your email</h1>
                            <p className="text-lg font-['Lexend']">We sent a 4-digit code to {localStorage.getItem(StorageVariables.ForgotUser)}</p>
                        </div>
                        <div className="flex flex-col gap-2">
                            ...
                            <div className="flex items-center flex-col gap-3  rounded-xl py-8 px-20">
                                <PinInput
                                    length={4}
                                    initialValue=""
