            ...
            }
            {
                reducer.notifications?.map(item => {
                    return (
                        ...
                        message={
                            <p className="w-full flex justify-between items-center"><span>Action {item.message}</span> <span className="font-medium text-white/80 whitespace-nowrap">{item.device}</span></p>
